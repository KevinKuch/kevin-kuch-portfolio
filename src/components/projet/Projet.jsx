		...
		<section className="Projet section" id="projet">
			...
			<RevealY>
				<span className="section__subtitle">
					Mes projets web tout au long de mon parcours scolaire
				</span>
			</RevealY>
			...
			<div className="projet__container container grid">
				...
				<div className="pro projet__content projet-1">
					<div className="projet__text">
						<h3 className="projet__title">Site web TIM</h3>
						<p
							className="projet__description"
							style={{ paddingBottom: "0.5rem" }}
						>
							Un site web conçu pour le département de Techniques d'intégration
							multimédia &#40;TIM&#41; dans le cadre du cours{" "}
							<u>Projet Web en équipe</u>.
						</p>
						<p className="projet__description">
							Nous utilisons <strong>React</strong> et <strong>Sass</strong>{" "}
							pour le développement de l'interface côté front-end, tandis que
							nous avons opté pour <strong>WordPress</strong> pour l'intégration
							de nos contenus.
						</p>
						...
						<div className="projet__link">
							<a
								href="https://github.com/ShawnOboy/Projet-Web-2023"
								target="_blank"
								rel="noreferrer"
							>
								Github
							...
							<a
								href="https://shawnoboy.github.io/Projet-Web-2023/"
								target="_blank"
								rel="noreferrer"
							>
								Demo
...
>>>>>>> e4a0f20f48108d68586a4c0defdb7332c8dc6334
				...
				<div className="pro projet__content projet-4">
					<div className="projet__text">
						...
						<p className="projet__description">
							Un jeu fait avec Javascript durant ma première session. Ceci est
							dans le but d'apprendre la programmation en commançant avec JS. On
							a utilisé le canvas pour réaliser le jeu.
						</p>
						<div className="projet__stack">
							<ul className="home__logo__skills">
								<li>
						...
						<div className="projet__link">
							<a
								href="https://github.com/KevinKuch/1J1_first_game"
								target="_blank"
								rel="noreferrer"
							>
								Github
							...
							<a
								href="https://kevinkuch.github.io/1J1_first_game/"
								target="_blank"
								rel="noreferrer"
							>
								Demo
